(function() {
  ...
  Comment = (function() {
    ...
    function Comment(options) {
      this._bindDatas = __bind(this._bindDatas, this);
      this._initVars(options)._render()._binds();
      return this;
    }
    ...
    Comment.prototype._bindDatas = function() {
      this._el = $(this._el);
      $.data(this._el, 'uid', this.uid);
    ...
    Comment.prototype._binds = function(options) {
      this._cc.dispatcher.on('bindDatasToCommentsItem', this._bindDatas);
      return this;
    };
  ...
  List = (function() {
    ...
    List.prototype._getInfosFromReply = function(target) {
      var infos, prev;
      infos = {
        index: this._index,
        parentId: 0,
    ...
    List.prototype._showForm = function(e) {
      var infos, reply, target;
      reply = $(e.target);
      infos = this._getInfosFromReply(reply);
      this._cc.dispatcher.trigger('hideAllForms');
    ...
    List.prototype._build = function() {
      ...
      this._cc.dispatcher.trigger('bindDatasToCommentsItem');
    ...
    Contextualcomments.prototype._getCommentsByIndexAndParentId = function(index, parentId) {
      ...
      this.comments.forEach(function(comment) {
        ...
        if (comment.index === index && comment.parentId === parentId) {
          item = _.extend({}, comment);
          item.children = that._getCommentsByIndexAndParentId(index, comment.uid);
          return comms.push(item);
        }
      });
      return comms;
    };
