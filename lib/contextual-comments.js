(function() {
  ...
  Contextualcomments = (function() {
    ...
    Contextualcomments.prototype.templateFile = 'template.html';
    ...
    Contextualcomments.prototype._initTemplates = function() {
      var that;
      that = this;
      $.when($.ajax(this.templatePaths + this.templateFile).success(function(data) {
        return that._containerTemplate = $('#containerTemplate', data).get(0).innerHTML;
      })).then(function() {
        return that._render();
      });
      return this;
